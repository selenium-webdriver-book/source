...
import static swip.ch18datepicker.bootstrapdatepicker.BootstrapByClassName.DISPLAY_MONTH_YEAR;
import static swip.ch18datepicker.bootstrapdatepicker.StringToMonth.TO_MONTH;

public enum BootstrapCalendarDisplayValue
    implements Function<Browser, Integer> {
